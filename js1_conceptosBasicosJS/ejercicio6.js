...
(DNI) es un proceso matemático sencillo que se basa en obtener 
...
let numDni = prompt("Escribe tu número de DNI", "Nº DNI");
console.log(String(numDni));

if (numDni > 99999999 || numDni < 0) {
  console.log("el número proporcionado no es válido");
} else {
    let letraDni  = numDni % 23;
  console.log("La letra es " + letras[letraDni]);
}
